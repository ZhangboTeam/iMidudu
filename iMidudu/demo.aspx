...
<body>
    ...
    <%
        ...
        if (string.IsNullOrEmpty(r.nickname))
        {
            ...
            var authUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx8cabe7121f5369a3&redirect_uri=" + System.Web.Configuration.WebConfigurationManager.AppSettings["Domain"] + "/demo.aspx&response_type=code&scope=snsapi_userinfo&state=" + this.Request["state"] + "#wechat_redirect";
     ...
     //   var exists = iMidudu.SystemDAO.SqlHelper.Exists(sql);
       ...
       // {
        ...
        var param = "?bouns=" + bouns + "&acitvity=" + acitvity + "&openid=" + rr.openid + "&code=" + this.Request["code"] + "&C=" + Server.UrlEncode(r.country) + "&P=" + Server.UrlEncode(r.province) + "&City=" + Server.UrlEncode(r.city) + "&Nickname=" + Server.UrlEncode(r.nickname) + "&Pic=" + r.headimgurl;
        var toUrl = "";
            ...
            <div class="txtWrap">
                ...
                <div class="txtCon">
                    ...
                    <dl>
                        ...
                        <dd> 微信扫二维码，根据提示输入您本人的手机号并获取短信验证码，十分钟内输入正确的验证码，经过验证即可获得微信红包。</dd>
                    </dl>
                    <dl>
