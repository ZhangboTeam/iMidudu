...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <script>
        ...
        function DownLoad() {
            ...
            //key3 = key3.AddDays(1);
            var sql = "select UserName as 验证用户名,Nickname as 微信昵称,Sex as 性别,Mobile as 手机, Country as 国家,Province as 省,City as 市, ActivityName as 活动名称,Amount as 领取金额,ReceiptDate as 领取时间 from ViewBonusHistory  where  ReceiptDate >=' " + k1 + "'   and ReceiptDate < '" + k3 + "'  ";
